    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="tplWebType">
          ...
          <el-select v-model="info.tplWebType">
            ...
            <el-option label="Vue3 轻量管理端模板" value="lmw" />
            <el-option label="Vue3 通用表单模板" value="bearjia" />
          </el-select>
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <template #label>
            生成包路径
            <el-tooltip content="生成在哪个 Java 包下，例如 com.smartparking.system" placement="top">
